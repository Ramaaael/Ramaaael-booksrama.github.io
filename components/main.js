...
function addBook(){
    ...
    const date = document.getElementById('addBooksDate').value;
    const completedCheckbox = document.getElementById('addBooksComplate');

    const generateID = generateId();
    let isComplete = completedCheckbox.checked;
    const bookObject = generateBookObject(title, author,date ,isComplete)
...
function generateBookObject(title,author,date,isComplete){
return{
    id: +new Date(),
    title,
    author,
...
function makeBook(bookObject){
    ...
    date.innerText = 'Tanggal: ' + bookObject.date;
    const container = document.createElement('div');
    container.classList.add('action');
    const bookContainer = document.createElement('article');
    bookContainer.classList.add('book-item');
    bookContainer.append(title, author, date, container);
